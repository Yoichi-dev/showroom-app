<template>
  <div id="bg">
    <img :src="require('/assets/tsukumo999/img/bg/song.png')" class="overlay" />
    <div id="comment-area">
...
#bg {
  width: 100vw;
  height: 100vh;
  background-image: url('~/assets/tsukumo999/img/bg/song.jpg');
}
...
@font-face {
  ...
  src: url('~/assets/tsukumo999/font/YujiBoku-Regular.ttf') format('truetype');
}
